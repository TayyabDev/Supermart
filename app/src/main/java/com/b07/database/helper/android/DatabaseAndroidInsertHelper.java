...
public class DatabaseAndroidInsertHelper extends DatabaseDriverAndroid {
  ...
  public long insertNewUser(String name, int age, String address, String password) {
    ...
    if (name != null && age >= 0 && address != null && address.length() <= 100 && password != null
        && password.length() <= 64) {
   ...
   */
  public long insertInventoryHelper(int itemId, int quantity, Context context)
   ...
   */
  public long insertItemizedSale(int saleId, int itemId, int quantity, Context context)
      throws DatabaseInsertException, SQLException, InvalidIdException, InvalidRoleException {
    DatabaseAndroidSelectHelper sel = new DatabaseAndroidSelectHelper(context);
   ...
   * @throws InvalidIdException if there is an invalid Id
   */
  public boolean insertAccountLine(int accountId, int itemId, int quantity, Context context)
      throws InvalidInputException, InvalidQuantityException, InvalidIdException {

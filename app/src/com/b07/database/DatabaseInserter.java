...
public class DatabaseInserter {
   ...
   * @throws DatabaseInsertException if there is a failure on the insert.
   */
  protected static int insertUserRole(int userId, int roleId, Connection connection)
      throws DatabaseInsertException {
   ...
   * @throws DatabaseInsertException if something goes wrong.
   */
  protected static int insertInventory(int itemId, int quantity, Connection connection)
      throws DatabaseInsertException {

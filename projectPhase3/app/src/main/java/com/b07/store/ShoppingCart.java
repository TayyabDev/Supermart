 ...
 */
  public void restoreShoppingCart() throws SQLException, InvalidInputException, InvalidIdException,
      ItemNotFoundException, InvalidQuantityException, DatabaseInsertException, CustomerNoAccountException {
  ...
  public void updateAccount() throws SQLException, DatabaseInsertException, InvalidInputException {
	  if(hasAccount) {
		 for(Item item : this.getItems()) {
		  // insert account line
		  DatabaseInsertHelper.insertAccountLine(this.customerAccountId, item.getId(), cart.get(item));
	  } 
	  }

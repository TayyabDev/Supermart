...
public class CustomerActivity extends AppCompatActivity implements View.OnClickListener {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    try {
      ...
      Toast.makeText(this, "Something went wrong. Perhaps you are not an customer?",
          Toast.LENGTH_LONG).show();
    } catch (InvalidIdException e) {
      Toast.makeText(this, "Something went wrong. Perhaps someone else is using the app?",
          Toast.LENGTH_LONG).show();
    } finally {
    ...
    switch (view.getId()) {
      ...
      case R.id.buttonCheckOut:
        ...
        if (sc.getItems().size() > 0) {
          ...
          a_builder.setMessage("Your total is: $" + sc.getTotal() + " after tax.")
              .setCancelable(false)
              .setPositiveButton("Confirm", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialogInterface, int i) {
                  ...
                  try {
                    ...
                    if (checkedOut) {
                      Toast.makeText(CustomerActivity.this, "You have successfully checked out!",
                          Toast.LENGTH_LONG).show();
                    } else {
                      Toast.makeText(CustomerActivity.this,
                          "Checkout not successful. Check your cart!", Toast.LENGTH_LONG).show();
                    }
                    // update the total
                    updateTotal();
                  }
      ...
      case R.id.buttonSave:
        ...
        if (sc.getItems().size() > 0) {
          ...
          a_builder.setMessage(
              "Please note that this can only be done once per account. You will have to" +
                  " contact an Admin to create a new account if you'd like to save your cart again")
              .setCancelable(false)
              .setPositiveButton("Confirm", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialogInterface, int i) {
                  ...
                  try {
                    ...
                    if (update) {
                      Toast.makeText(CustomerActivity.this, "Items saved", Toast.LENGTH_SHORT)
                          .show();
                    } else {
                      Toast.makeText(CustomerActivity.this, "Items not saved", Toast.LENGTH_SHORT)
                          .show();
                    }
                  } catch (Exception e) {
                    Toast.makeText(CustomerActivity.this,
                        "Contact admin to make a new account. You have already saved once.",
